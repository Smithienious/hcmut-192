...
public:
	...
	bool skill1(Champion &obj) override
	{
		return obj.takePhysicalDamage(100 + (physicalDamage * 20) / 100);
	}
	bool skill2(Champion &obj) override
	{
		return obj.takePhysicalDamage(20 + (physicalDamage * 80) / 100);
	}
};
...
public:
	...
	bool skill1(Champion &obj) override
	{
		return obj.takeMagicDamage(30 + (abilityPower * 70) / 100);
	}
	bool skill2(Champion &obj) override
	{
		return obj.takeMagicDamage(90 + (abilityPower * 30) / 100);
	}
};
